...
class UnknownCommand(Exception):
    """Raised when an unknown command is parsed."""

    def __init__(self, command: str):
        """Create a custom message for the exception."""
...
@dataclass
class CommandV1:
    """Represent a command for the part 1 of the day 2 puzzle."""

    delta_h: int
    delta_d: int

    def __init__(self, raw_command: str):
        """Build a command from a raw description of it."""
...
@dataclass
class CommandV2:
    """Represent a command for the part 2 of the day 2 puzzle."""
